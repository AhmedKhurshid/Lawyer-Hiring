...
if (isset($_POST['update'])) {
    ...
    $q="UPDATE `about` SET `img`='$img',`heading`='$heading',`text`='$text' WHERE `id`='$id'";
...
<section class="main_content dashboard_part">
    ...
    <input type="text" value="<?php echo $row[1] ?>" name="image" class="form-control form-group" style="height:40px;font-size:15px;">
    </div>
    <div class="col-sm-4">
